...
class UpdateWeightSheet extends StatefulWidget {
  final String initialWeight;
  final TrackerController trackerController;
  const UpdateWeightSheet({
    super.key,
    required this.initialWeight,
    required this.trackerController,
  });

  @override
  State<UpdateWeightSheet> createState() => _UpdateWeightSheetState();
}

class _UpdateWeightSheetState extends State<UpdateWeightSheet> {
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () async {
                    await widget.trackerController.updateWeight(
